...
การเพาะเลี้ยงเนื้อเยื่อ (in vitro) เป็นเทคโนโลยีขยายพันธุ์พืชที่สำคัญทั้งในระดับโลกและไทย โดยเฉพาะกล้วยไม้ซึ่งเป็นสินค้าส่งออกสำคัญ (Thammasiri, 2015) และระบบ bioreactor สำหรับปาล์มน้ำมัน/มะพร้าวช่วยเพิ่มความเร็วการขยายพันธุ์ 3–4 เท่า (ไบโอเทค, 2563) ทำให้สามารถผลิตต้นกล้าจำนวนมากได้ในพื้นที่จำกัด อย่างไรก็ตาม ขั้นตอนที่เป็นคอขวดคือการตัดสินใจว่าเมื่อใดควรย้ายต้นออกอนุบาล (acclimatization) ซึ่งปัจจุบันทำด้วยสายตาเป็นรายขวด ใช้แรงงานและค่าใช้จ่ายสูง (ค่าแรงคิดเป็น 60–70% ของต้นทุน — Bethge et al., 2023) ผลการตัดสินใจยังมีความแปรปรวนระหว่างผู้ประเมิน (Zhang et al., 2026; Nguyen et al., 2025) และการตัดสินใจเร็วหรือช้าเกินอาจทำให้เกิดความผิดปกติของเนื้อเยื่อ เช่น hyperhydricity หรือการตายของเนื้อเยื่อ

นอกเหนือจากปัญหาเรื่องแรงงานและความไม่คงเส้นคงวาแล้ว การวัดสภาพต้นในขวดยังถูกจำกัดด้วยตัวขวดแก้วปิด — การเปิดขวดเพื่อตรวจเสี่ยงการปนเปื้อน จึงจำเป็นต้องมีวิธีประเมินสภาพแบบไม่ทำลาย (non-destructive) งานที่มีอยู่จำนวนหนึ่งใช้การถ่ายภาพวัดลักษณะของต้น เช่น งานของ Regni et al. (2025) ที่ใช้ภาพ 3D วัดพื้นที่ปกคลุมของต้นต่อขวดใน blackberry/blueberry แต่จำกัดเฉพาะชนิดพืช และยังไม่มีการตรวจวัดแบบข้ามชนิดโดยไม่ต้องฝึกแบบจำลองใหม่

จากช่องว่างดังกล่าว โครงงานนี้จึงพัฒนาและประเมินระบบคัดกรองความพร้อมอนุบาลของต้นเพาะเลี้ยงเนื้อเยื่อแบบไม่ทำลายผ่านขวดแก้ว โดยใช้แบบจำลอง Segment Anything Model 3 (SAM3) ในโหมด Promptable Concept Segmentation (PCS) แบบ zero-shot แบ่งส่วนภาพต้นด้วยพรอมป์ข้อความ แล้วคำนวณลักษณะเชิงปริมาณเพื่อจัดกลุ่มความพร้อม — มุ่งให้เป็นระบบต้นทุนต่ำ (สมาร์ตโฟน + Google Colab ฟรี + โมเดล open-source) ที่ทำงานข้ามชนิดโดยไม่ต้องฝึกแบบจำลองใหม่ต่อชนิด
