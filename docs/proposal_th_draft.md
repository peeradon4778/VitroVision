...
**ผลนำร่อง (pilot) บนภาพจริง 100 ขวดพริกจินดา (รัน Colab T4, 18 สิงหาคม 2569) ยืนยันความเป็นไปได้ของแนวทาง:** ความสัมพันธ์เชิงปริมาณที่สมเหตุผลเชิงชีววิทยา (จำนวนใบกับพื้นที่ปกคลุม r = 0.760, สัดส่วนเขียวกับสุขภาพต้น r = 0.922) และการประมวลผล 100 ขวดภายในเวลาประมาณ 15 นาที — ใช้เพียงสมาร์ตโฟน, Google Colab ฟรี และโมเดล open-source (ต้นทุนต่ำสุด)
...
ผลการทดลองนำร่องบนภาพจริง 100 ขวดพริกจินดา (รัน Colab T4, 18 สิงหาคม 2569) ยืนยันความเป็นไปได้ของแนวทาง:

**การจัดกลุ่ม verdict (100 ขวด):**

| กลุ่ม | จำนวนขวด |
|---|---|
| พร้อมอนุบาล | 13 |
| ยังไม่พร้อม | 51 |
| ตรวจเอง (ROI ไม่ชัด) | 36 |
...
ทุกคู่เป็นบวกและสมเหตุผลเชิงชีววิทยา — ใบมากสัมพันธ์กับพื้นที่ปกคลุมมาก และสัดส่วนสีเขียวสัมพันธ์กับสุขภาพต้น เวลาประมวลผลรวม 100 ขวดประมาณ 15 นาที **ข้อจำกัดที่พบ:** 36% ของขวดที่ตรวจหาขวด (ROI) ไม่พบ → ต้องส่งให้มนุษย์ตรวจ — เป็นจุดที่โครงงานนี้จะปรับปรุงต่อ [RESULT — ตามบันทึก DEV_LOG 18–19 ส.ค. 2569]
