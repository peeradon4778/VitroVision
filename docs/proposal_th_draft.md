...
**ข้อจำกัดจากผลจริง:** (1) การตรวจจับระบบรากยังไม่ได้ผล — ตรวจพบรากเพียง 1/100 ภาพ จึงไม่ได้ใช้ root_ratio เป็นตัวชี้วัดอันดับ 1 ในรอบนี้ (หันไปใช้ความสูงแทนตามมุมผู้เชี่ยวชาญ) [OPEN — ต้องปรับปรุงพรอมป์/วิธี] (2) ยังไม่ได้สอบเทียบหน่วยทางกายภาพ (canopy_h_cm/canopy_w_cm เป็น NaN) [OPEN — CALIBRATION_GUIDE] (3) ผลเป็น pilot (n = 98 ภาพที่ผู้ประเมินระบุชัด) ยังต้องตรวจกับผู้ประเมินหลายคน (inter-rater) ก่อนยืนยันเป็นข้อสรุป [PLAN] การประเมินเปรียบเทียบกับวิธีพื้นฐาน (baseline) ยังอยู่ระหว่างดำเนินการ [PLAN]
