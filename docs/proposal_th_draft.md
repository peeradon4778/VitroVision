...
**ผลนำร่อง (pilot):** ชุดภาพจริง 100 ขวดพริกจินดาประมวลผลบน Colab ได้ผลแล้ว (14 พร้อมอนุบาล / 51 ยังไม่พร้อม / 35 ตรวจเอง) — ใช้เพียงสมาร์ตโฟน, Google Colab ฟรี และโมเดล open-source (ต้นทุนต่ำสุด) [RESULT]
...
| พร้อมอนุบาล | 14 | 14% |
| ยังไม่พร้อม | 51 | 51% |
| ตรวจเอง (ROI ไม่ชัด) | 35 | 35% |

**ความสัมพันธ์เชิงปริมาณ (Pearson r):** coverage↔พื้นที่ฉายภาพ = 0.949, ใบ↔coverage = 0.852, สัดส่วนเขียว↔healthy = 0.910, coverage↔ความสูง = 0.701, ใบ↔shoot = 0.534 ([RESULT] — sanity check)

**ข้อจำกัดจากผลจริง:** (1) การตรวจจับระบบรากยังไม่ได้ผล — ตรวจพบรากเพียง 1/100 ภาพ จึงยังยืนยัน root_ratio เป็นตัวชี้วัดอันดับ 1 ไม่ได้ [OPEN — ต้องปรับปรุงพรอมป์/วิธี] (2) ยังไม่ได้สอบเทียบหน่วยทางกายภาพ (canopy_h_cm/canopy_w_cm เป็น NaN) [OPEN — CALIBRATION_GUIDE] การประเมินเปรียบเทียบกับวิธีพื้นฐาน (baseline) และการสร้างค่าอ้างอิงจากผู้ประเมินยังอยู่ระหว่างดำเนินการ [PLAN]
