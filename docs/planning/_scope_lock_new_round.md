...
| รายการ | คำตอบ |
|---|---|
| **ปัญหา** | การตัดสินใจ "พร้อมอนุบาล" (ย้ายออกขวด) ของพืชเพาะเลี้ยงเนื้อเยื่อยังพึ่งพาสายตาคนเป็นรายขวด — คอขวดแรงงาน/เวลา มีความแปรปรวนระหว่างผู้ประเมิน |
| **คำถามวิจัย** | ด้วยภาพถ่ายเพียงภาพเดียว + SAM3 PCS zero-shot segmentation + rule-based triage จัดกลุ่มขวด (ยังไม่พร้อม / พร้อมอนุบาล / ตรวจเอง) ได้ถูกต้องแค่ไหน? |
...
| **ข้อมูล** | ชุดภาพใหม่ — [OPEN: รอ path จากผู้ใช้] · เดิม: 51 ขวด (16/07/2569) ชนิดพริกจินดา ตามข้อมูลจริง |
